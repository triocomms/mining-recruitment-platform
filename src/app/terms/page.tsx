export const metadata = {
  title: "Terms of Service — FiFoDiDo",
  description: "The terms that govern use of FiFoDiDo by candidates and employers.",
};
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-2 text-ink/70">
        These terms govern your use of FiFoDiDo. By creating an account you agree to them. If
      ...
      <section className="mt-8 space-y-6 text-ink/85">
        <div>
          <h2 className="font-display text-2xl uppercase tracking-wide">Who can use FiFoDiDo</h2>
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed">
            ...
            By posting it, you give FiFoDiDo a licence to host, display, and distribute it on the
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed">
            ...
            tiers rather than per click or per application. Payments are processed by Stripe — FiFoDiDo
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed">
            FiFoDiDo is provided &ldquo;as is.&rdquo; We moderate listings but can&rsquo;t guarantee every ad,
            application outcome, or piece of user-submitted content (including reviews and news posts) is
            accurate. To the extent permitted by law, FiFoDiDo isn&rsquo;t liable for indirect or
