...
// Employer-facing mining sites CRUD, scoped to the signed-in employer's own
// company. Distinct from src/app/api/admin/sites — that route is unscoped
// (admin only) and can publish directly; this one can only ever create a
// site as DRAFT or, once the employer hits "Submit for review", as
// PENDING_REVIEW. Only an admin (src/app/api/admin/sites/[siteId]) can move
// a site to PUBLISHED, same approve/reject shape as employer job ads.
