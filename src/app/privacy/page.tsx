export const metadata = {
  title: "Privacy — FiFoDiDo",
  description: "How FiFoDiDo collects, uses, and protects your personal data, and how to exercise your rights.",
};

export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      <h1 className="font-display text-4xl uppercase tracking-wide">Privacy at FiFoDiDo</h1>
